  ...
  return (
    <div className=' relative w-full h-full flex items-center justify-center overflow-hidden'>
      ...
      <article className={'relative bg-cover bg-no-repeat  bg-top w-full md:w-[1600px] h-full z-10 flex items-center md:px-16'}>
        <Image alt={`Big poster of the movie ${title}`} src={`https://image.tmdb.org/t/p/original${bigPoster}`} priority={true} fill={true} style={{ objectFit: 'cover', objectPosition: 'top' }} className='max-md:pt-16 max-md:pb-32'/>
