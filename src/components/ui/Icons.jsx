...
export function FlagESIcon () {
  return (
    <Image className='w-6' width={24} height={15} src='/ui/flagES.png' alt="Flag of Argentina" />
  )
}

export function FlagENIcon () {
  return (
    <Image className='w-6' width={24} height={13} src='/ui/flagEN.png' alt="Flag of the United States" />
  )
}
