...
export function MediaTypeSwitcher () {
  ...
  return (
    <div className='relative rounded-full outline bg-slate-800/60 outline-gray-800 outline-2 border-4 border-transparent w-48 h-10 group ml-auto' >
      ...
      <div className='relative flex  items-center py-1 z-10 font-semibold h-full '>
